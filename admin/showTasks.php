<?php
 ...
 include("handlers/show_tasks.php")
 ?>
          ...
          <div class="card card-primary">
            ...
            <div class="row">
              ...
              ?>
                  ...
                  <tbody>
                     <?php
                       while($task=mysqli_fetch_assoc($queryGetTasks)){
                           ?>
                          <tr>
                              <td><?= $task['title']?></td>
                              <td><?= $task['name']?></td>
                             ...
                             <td>
                        <a href="handlers/delete_task.php?taskid=<?= $task['id']?>"><i class="fas btn btn-danger fa-trash-alt"></i></a>
                        <a href="handlers/approve_task.php?taskid=<?= $task['id']?>"><i class="fas btn btn-info ml-4 fa-check-square"></i></a>
                    </td>
                          </tr>
